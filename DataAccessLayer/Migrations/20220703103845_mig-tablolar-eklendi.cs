...
{
    public partial class migtablolareklendi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqeId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Serviceproducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Serviceproducts_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Serviceproducts_Servicestatuses_ServicestatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProducts_Serviceproducts_ServiceproductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Serviceproducts_CustomerId",
                table: "Serviceproducts",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_Serviceproducts_ServicestatusId",
                table: "Serviceproducts",
                column: "ServicestatusId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProducts_ServiceproductId",
                table: "UserProducts",
